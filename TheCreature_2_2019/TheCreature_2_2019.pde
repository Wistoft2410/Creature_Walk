...
void draw() {                          
  ...
  ballSize      =  (ballSize*zoomFactorBall); //gør mit bold størrere
  eyeSize       =  (eyeSize*zoomFactorBall);
  eyeRightRelativeX *=zoomFactorBall;
  eyeRightRelativeY *=zoomFactorBall;
  eyeLeftRelativeX  *=zoomFactorBall;
  eyeLeftRelativeY  *=zoomFactorBall;
  ...
  println("Dette er x værdien af ball position:"+ballX);
}
